/**
 * Class taken from Ardity (Serial Communication for Arduino + Unity) | Author: Daniel Wilches <dwilches@gmail.com>
 */
...
{
    public abstract class SerialThread
    {
            ...
            try
            {
                while (!IsStopRequested())
                {
                    ...
                    catch (Exception ioe)
                    {
                        ...
                        Debug.LogError("Exception: " + ioe.Message + " StackTrace: " + ioe.StackTrace);
